...
#Autor: Bertulfo Molina Cuartas
#Correo Electrónico: bertulfo.molina@correounivalle.edu.co
#Fecha de Creación: 2024-11-12
#Fecha de Última Modificación: 2024-11-12

#Versión: 1.0.0

#Descripción: Este programa gestiona un inventario de productos. Permite agregar nuevos productos, actualizar el stock, y mostrar los detalles del inventario
